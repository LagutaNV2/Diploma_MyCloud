...
, где
  ...
  $(date +%Y-%m-%d) - динамически подставляет текущую дату в имя файла (например, `backup_2023-10-05.sql`) для перенаправления вывода в файл с соответствующим именем.
...
nginx
# В /etc/nginx/sites-available/my_cloud
